...
/**
 * cglib相关性能测试对比
 * http://www.iteye.com/topic/801577
 * 测试数据仅拱参考
 * @author n004881
 *
 */
public class CglibPerformanceTest {
    ...
    public static void testReflectCopy() {
        ...
        // 测试BulkBean
        final BulkBean bulkBean = BulkBean.create(bean.getClass(), new String[] {
            getMethodName
        }, new String[] {
            setMethodName
        }, new Class[] {
        ...
        final FastMethod setFastMetod = fastClass.getMethod(setMethodName, new Class[] {
            Integer.class
        });
        ...
        testTemplate(new TestCallback() {
            ...
            public CopyBean call(CopyBean source) {
                ...
                try {
                    ...
                    setFastMetod.invoke(fastClassTarget, new Object[] {
                        field
                    });// 调用set方法赋值
                } catch (Exception e) {
                    e.printStackTrace();
        ...
        try {
            ...
            final Method setMethod = bean.getClass().getMethod(setMethodName, new Class[] {
                Integer.class
            });
            // 测试未处理过的Reflect
            ...
            testTemplate(new TestCallback() {
                ...
                public CopyBean call(CopyBean source) {
                    try {
                        ...
                        setMethod.invoke(reflect1Target, new Object[] {
                            field
                        });
                    } catch (Exception e) {
                        e.printStackTrace();
            ...
            testTemplate(new TestCallback() {
                ...
                public CopyBean call(CopyBean source) {
                    try {
                        Object field = getMethod.invoke(source, new Object[] {});
                        setMethod.invoke(reflect2Target, new Object[] {
                            field
                        });
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    public static void testTemplate(TestCallback callback, CopyBean source, int count) {
        ...
        System.out.println(callback.getName() + " total cost=" + integerFormat.format(nscost) + "ns , each cost=" + nscost / count + "ns");
        restoreJvm();// 进行GC回收
