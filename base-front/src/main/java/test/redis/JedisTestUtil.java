...
public class JedisTestUtil {
    ...
    static {
        ...
        //redis如果设置了密码：
        jedisPool = new JedisPool(config, "10.20.81.63", 6379, 10000, "123456");

        //redis未设置了密码：
        //jedisPool = new JedisPool(config, "10.20.81.63", 6379);
    }
    ...
    private static final JedisTestUtil jedisUtil = new JedisTestUtil();

    /**
     * 获取JedisUtil实例
     * @return
     */
    public static JedisTestUtil getInstance() {
        return jedisUtil;
    }
...
//        test1();
    ...
    public static void test1() {
        JedisTestUtil jedisTestUtil = JedisTestUtil.getInstance();
        Strings strings = jedisTestUtil.new Strings();
    ...
    public static void test3() {
        ...
        Map<String, Object> p1 = (Map<String, Object>) SerializeUtil.unserialize(personBy);
