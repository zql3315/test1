	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="form-wrap-tpl">
				<form role="form" class="form-tpl" method="POST" id="tableForm">
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('#addBtn').on('click',function(){
				...
				lastItem['data-action']="${ctx}/table/preview";
				console.log(lastItem);
				breadcrumb_items[breadcrumb_items.length-1]=lastItem;
				
				breadcrumb_items.push({'text': $(this).text(), 'data-action': '${ctx}/table/toAdd'});
				breadcrumb_items.reverse();
				//渲染breadcrumb
				refreshBreadcrumb(breadcrumb_items);
				
				$('div').find('.page-content').load('${ctx}/table/toAdd',function(){
					 //加一个遮罩在次
				});
			});
			...
			$('#editBtn').on('click',function(){
				...
				breadcrumb_items.push({'text': $(this).text(), 'data-action': '${ctx}/table/toEdit'});
				breadcrumb_items.reverse();
				//渲染breadcrumb
				refreshBreadcrumb(breadcrumb_items);
				...
				$('div').find('.page-content').load('${ctx}/table/toEdit/'+selected_id,function(){
					 //加一个遮罩在次
				});
			});
