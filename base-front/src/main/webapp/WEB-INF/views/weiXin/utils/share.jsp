...
<script>
    $(function(){
        ...
        $.post("${ctx}/share/getJsapiSign",{"url":url},function(data){
	        var shareUrl = 'http://e574a365ac9f.vxplo.cn/idea/a5zvWJj';
	        var shareTitle = "中英爱守护重疾险震撼上市";
	        var shareimageurl = '${domainUrl}${ctx}'+"/static/zyrenbao/images/sharelogo.jpg";
		    //通过config接口注入权限验证配置
		    wx.config({
		    ...
		    wx.ready(function() {
	           wx.onMenuShareTimeline({
				   title: '中英爱守护重疾险震撼上市', // 分享标题
				   desc: '任性保障一赔再赔 百种疾病不分组 多重赔付伴终身',
				   link: shareUrl, // 分享链接
