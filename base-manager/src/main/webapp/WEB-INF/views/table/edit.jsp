								...
								<div class="form-info-row">
								    ...
								    <div class="form-info-value">
									    <select class="chosen-select" id="project">
											<option value="${project.id}">${project.name} -> ${project.mName}</option>
										</select>
									</div> 
								</div>
								<div class="form-info-row">
									...
									<div class="form-info-value">
										...
										<input type="text"  placeholder="数据表名" name="name" value="${model.name }" class="col-xs-10 col-sm-5">
									</div>
								</div>
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<input type="text"  placeholder="实体对象名 " name="eName" value="${model.eName }" class="col-xs-10 col-sm-5">
									</div>
								</div>
								<div class="form-info-row">
						...
						<div id="edit-advance" class="tab-pane">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createPO" _class="chosen-select" value="${model.createPO}"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createDTO" _class="chosen-select" value="${model.createDTO}"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createDAO" _class="chosen-select" value="${model.createDAO }"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createService" _class="chosen-select" value="${model.createService }"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createController" _class="chosen-select" value="${model.createController }"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createAddView" _class="chosen-select" value="${model.createAddView }"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createModView" _class="chosen-select" value="${model.createModView }"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
							...
							<div class="form-info">
								<div class="form-info-row">
									...
									<div class="form-info-value">
										<sys:selectItem datakey="dd_whether_key" name="createListView" _class="chosen-select" value="${model.createListView }"></sys:selectItem>
									</div>
								</div>
								<div class="form-info-row">
