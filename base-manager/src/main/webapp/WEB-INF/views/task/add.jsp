		...
		<form role="form" class="form-horizontal" method="POST" id="form">
			<div class="form-info form-info-striped">
					...
					<div class="form-info-row">
						...
						<div class="form-info-value">
							<input type="text"  placeholder="类型" name="type" value="${model.type}" class="col-xs-10 col-sm-5">
						</div>
					</div>
					<div class="form-info-row">
						<div class="form-info-name"> 状态 </div>
						<div class="form-info-value">
							<input type="text"  placeholder="状态" name="status" value="${model.status}" class="col-xs-10 col-sm-5">
						</div>
					</div>
					<div class="form-info-row">
					...
					<div class="form-info-row">
						...
						<div class="form-info-value">
							<input type="text"  placeholder="创建者" name="creator" value="${model.creator}" class="col-xs-10 col-sm-5">
						</div>
					</div>
					<div class="form-info-row">
						<div class="form-info-name"> 最后更新时间 </div>
						<div class="form-info-value">
							<input type="text"  placeholder="最后更新时间" name="lastmodtime" value="${model.lastmodtime}" class="col-xs-10 col-sm-5">
						</div>
					</div>
