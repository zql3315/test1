	...
	<div class="row">
		<div class="col-xs-12">
			<h3 class="header smaller lighter blue">
				<i class="ace-icon fa fa-pencil-square-o"></i>添加菜单
			</h3>
				...
				<div class="form-info form-info-striped">
						...
						<div class="form-info-row">
							...
							<div class="form-info-value">
								<input type="text"  placeholder="菜单名称" name="menuName"  class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-info-row">
						...
						<div class="form-info-row">
							...
							<div class="form-info-value">
								<input type="text"  placeholder=" 响应内容" name="triggerContent"  class="col-xs-10 col-sm-5">
							</div>
						</div>
						<div class="form-info-row">
							...
							<div class="form-info-value">
								<input type="text"  placeholder="序号" name="orderNum"  class="col-xs-10 col-sm-5">
							</div>
						</div>
					
				</div>
				<input type="hidden" name="pid" value="${model }"/>
