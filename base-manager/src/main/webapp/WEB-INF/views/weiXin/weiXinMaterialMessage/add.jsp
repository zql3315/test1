...
<script type="text/javascript">
  	window.UEDITOR_HOME_URL = "/base-manager/static/bdedit/";
</script>
<title>微信图文消息</title>
<style type="text/css">
.content_cover {
...
<body>
			...
			<div class="form-info form-info-striped">
				...
				<div class="form-info-row">
					...
					<div class="form-info-value">
						...
						<input type="hidden" placeholder="过期时间" name="failtime" value="" class="col-xs-10 col-sm-5">
						<input type="hidden" placeholder="多媒体文件" name="materialid" value="1" class="col-xs-10 col-sm-5">
					</div>
				</div>
				<!-- 作者 -->
				<div class="form-info-row">
				...
				<div class="form-info-row">
					...
					<div class="form-info-value">
						<input type="text"  placeholder="跳转链接地址" name="content_source_url" value="${model.content_source_url}" class="col-xs-10 col-sm-5">
					</div>
				</div>
				<!-- 描述信息 -->
				<div class="form-info-row">
					...
					<div class="form-info-value">
					    <textarea rows="3" placeholder="描述信息" name="digest" class="col-xs-10 col-sm-5">${model.digest}</textarea>
					</div>
				</div>
				<!-- <div class="form-info-row">
					<div class="form-info-name">资讯内容<span style='color:red'>*</span></div>
					<div class="form-info-value" style="padding-left: 0px;">
						加载编辑器的容器
       					<script id="container" name="description" type="text/plain"  class="col-xs-10 col-sm-5"></script>
					</div>
				</div> -->
			</div>
	...
	<!-- 配置文件 -->
<%--     <script type="text/javascript" src="${ctx}/static/bdedit/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="${ctx}/static/bdedit/ueditor.all.js"></script> --%>
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$('#form').validate({
				rules:{
						...
						content_source_url:{required: true}, 
						picurl:{required: true}, 
						title:{required: true}
				},
				messages:{
						author:{required: '请输入作者'}, 
						digest:{required: '请输入描述信息'}, 
						content_source_url:{required: '请输入图文消息链接'}, 
						picurl:{required: '请输入图片链接地址'}, 
						title:{required: '请输入自动回复消息标题'}
				},
