...
<body>
	<div class="row">
		<div class="col-xs-12">
			...
			<form role="form" class="form-horizontal" method="POST" id="weiXinMaterial">
				<div class="form-info form-info-striped">
					...
					<div class="form-info-row">
						...
						<div class="form-info-value">
							...
							<input type="hidden" placeholder="过期时间" name="failtime" value="${model.failtime }" class="col-xs-10 col-sm-5">
						</div>
					</div>
					<!-- 作者 -->
					<div class="form-info-row">
					...
					<div class="form-info-row">
						...
						<div class="form-info-value  col-sm-5"  >
						    <img id="imgbg" src="../b2r-build/${model.picurl}" class="content_cover">
							...
							<input type="hidden"  id="picurl" name="picurl" value="${model.picurl }">
						</div>
					</div>
					<!-- 链接地址 -->
					<div class="form-info-row">
			...
			$('#weiXinMaterial').validate({
				...
				submitHandler:function(form){
					...
					if ($.isArray(formData)) {
						...
						$.ajax({
							url : '${ctx}/weiXin/weiXinMaterialMessage/edit',
							type : 'POST',
							async : false,
							dataType : 'json',
