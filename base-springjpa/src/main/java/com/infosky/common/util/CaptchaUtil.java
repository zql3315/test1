...
public class CaptchaUtil {
    ...
    public BufferedImage genRandomCodeImage(StringBuffer randomCode) {
        return genRandomCodeImage(width, height, randomCode);
    }

    /**
     * 生成随机图片
     */
    public BufferedImage genRandomCodeImage(int width, int height, StringBuffer randomCode) {
    ...
    private void drowLine(Graphics g) {
        ...
        int x0 = random.nextInt(6)+1;
        int y0 = random.nextInt(12)+1;
        g.drawLine(x, y, x + x0+40, y + y0+20);
    }
