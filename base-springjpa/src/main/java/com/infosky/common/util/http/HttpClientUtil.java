package com.infosky.common.util.http;
...
public class HttpClientUtil {
    ...
    public static void main(String[] args) {
        //        HttpResponse s =httpDelete("http://58.213.29.50:9200/_watcher/watch/ab5a8593-7f3c-4f9c-8418-197f2e171674", null, null);
     ...
     * 发送http get请求  
     */
    public static HttpResponse httpGet(String url, String encode) {
        return httpGet(url, null, encode);
    }
     ...
     */
    public static HttpResponse httpPostForm(String url) {
        return httpPostForm(url, null);
    }
    ...
    public static HttpResponse httpPostForm(String url, Map<String, String> params) {
        return httpPostForm(url, params, "utf-8");
    }

    /**  
     * 发送 http post 请求，参数以form表单键值对的形式提交。  
     */
    public static HttpResponse httpPostForm(String url, Map<String, String> params, String encode) {
        return httpPostForm(url, params, null, encode);
    }
     ...
     * @return  
     */
    public static HttpResponse httpPostRaw(String url, String stringJson) {
        return httpPostRaw(url, stringJson, null, null);
    }
     ...
     * @return
     */
    public static HttpResponse httpPostRaw(String url, String stringJson, String encode) {
        return httpPostRaw(url, stringJson, null, encode);
    }
    ...
    public static HttpResponse httpPostRaw(String url, String stringJson, Map<String, String> headers) {
        return httpPostRaw(url, stringJson, headers, "utf-8");
    }
